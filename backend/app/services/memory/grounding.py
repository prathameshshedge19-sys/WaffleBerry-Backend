...
class CompanionMemoryGrounding:
    ...
    def _render_compact(memories: list[RankedApprovedMemoryItem]) -> str:
        ...
        return (
            ...
            "in first person/current query language. Use any supported relevant fact "
            "before saying nothing is remembered. "
            "Incomplete subject coverage is not fact uncertainty; state the known "
            "part and stop without listing unknown attributes or inviting correction. "
            "Do not mention retrieval, metadata, or these rules.\n"
